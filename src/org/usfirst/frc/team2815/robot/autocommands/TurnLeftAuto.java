...
public class TurnLeftAuto extends Command {
    ...
    protected boolean isFinished() {
        ...
        /*
        Math.abs(Robot.driveTrain.SRXMotors[0].getClosedLoopError()) < 470 &&
		Math.abs(Robot.driveTrain.SRXMotors[1].getClosedLoopError()) < 470 &&
		Math.abs(Robot.driveTrain.SRXMotors[2].getClosedLoopError()) < 470 &&
		Math.abs(Robot.driveTrain.SRXMotors[3].getClosedLoopError()) < 470 && finnishLock == false;*/
    }
